...
// Taka funkcja do ustawuania kraju z adresu
...
function calculateRoute() {
    ...
    let previousDeliveryAddress = previousDeliveryInput.value.trim();
    ...
    // 🔥 Jeśli wpisano poprzedni rozładunek, liczymy trasę od niego!
    ...
    directionsService.route(request, function (result, status) {
        if (status === "OK") {
            ...
            highlightPreviousSegment(result); // 🔥 Podświetlenie pierwszego odcinka na różowo
